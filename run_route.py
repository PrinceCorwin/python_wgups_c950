...
def run_route():
    truck1_start = 8
    truck1_list = truck_route(truck1, truck1_start)
    truck2_start = 9.08
    truck2_list = truck_route(truck2, truck2_start)
    truck3_start = (truck1_start + (truck1_list[1] / 18))
    truck3_list = truck_route(truck3, truck3_start)
...
def truck_route(truck, start):
    ...
    return [route, truck_distance, delivered_pkg]
